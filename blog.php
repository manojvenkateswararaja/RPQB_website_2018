    ...
    <div class="container-fluid">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="col-md-5 ml-auto">
                                    ...
                                    <p class="heading pnSB ml-3 mt-2">Blockchain technology  in 2018</p>
                                                        <div class="container-fluid">
                                                            ...
                                                            <button class="btn  btn-link ml_67" type="button" data-toggle="collapse" data-target="#blog2"
                            ...
                            <div class="col-md-5 ml-auto">
                                    ...
                                    <p class="heading pnSB ml-3 mt-2">Blockchain technology  in 2018</p>
                                                        <div class="container-fluid">
                                                            ...
                                                            <button class="btn  btn-link ml_67" type="button" data-toggle="collapse" data-target="#blog4"
                            ...
                            <div class="col-md-5 ml-auto">
                                    ...
                                    <p class="heading pnSB ml-3 mt-2">Blockchain technology  in 2018</p>
                                                        <div class="container-fluid">
                                                            ...
                                                            <button class="btn  btn-link ml_67" type="button" data-toggle="collapse" data-target="#blog6"
                ...
                <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
                  <span class="fa fa-angle-left mr_86" style="background-color:grey;" aria-hidden="true"></span>
                  <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
                  <span class="fa fa-angle-right ml_86" style="background-color:grey;" aria-hidden="true"></span>
