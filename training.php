...
<br><br>
  ...
  <div class="row">
    <div class="col-sm-4">
      <h3><b>Markets on Blockchain</b> </h3>        
    ...
    <div class="col-sm-4">
      <h3><b>Some of the Indian Blockchain Initiatives</b></h3>   
...
<div class="row">
  ...
  <div class="row">
    ...
    <img href="#" data-toggle="modal" data-target="#myModal" src="assests/mohan_trainingImg.png" srcset="assests/mohan_trainingImg.png"
          class="Etherium">
          <p style="margin-left: 18px;">Mohan Raj</p>
    </div>
    <div class="col-sm-2">
...
<!-- </form> -->
            ...
            <div class="form-group">
            <label class="float-label regFormFonts" name="program" for="exampleInputEmail1">Program Duration  and Structure</label>
            ...
            <div class="form-group">
            <p style="margin-left: 99px;
    margin-top: -8px;">New training course beginning on 20 November 2018</p>
            <p style="margin-left: 241px;">Rs.17999/-</p>
            </div>
            <div class="form-group">
