...
<div class="container-fluid">   
        <div class="row" style="background-color: #ffffff;
                box-shadow: 0 5px 5px 0 rgba(0, 0, 0, 0.13);width:114%">
            <div class="col-md-2 mb-3 img_style">
            <a href="landingpage.php"> <img class="rapidlogo" src="assests/rapidqube-logo-2.png" alt="rapidqube"></a>
...
<div class="col-md-8"></div>
 <div class="collapse navbar-collapse col-md-1" id="navbarNavAltMarkup">
    <a class="fa fa-home navBarhome" href="landingpage.php"></a>
</div>
 <div class="collapse navbar-collapse col-md-1" id="navbarNavAltMarkup">
 ...
 <div class="collapse navbar-collapse blog" id="navbarNavAltMarkup">
    <a class="navBarNameBlog" href="blog.php">Blog</a>
</div>
</div>
                <div class="border"></div>
                <div class="border"></div>
                <nav class="navbar navbar-expand-lg navbar-light bg-light hiddenstyle">
                    <!-- <a class="navbar-brand" href="#">Navbar</a> -->
                    <!-- <a class="navbar-brand" href="landingpage.php"> <img src="assests/rapidqube-logo-2.png" alt="rapidqube"></a> -->
                    <button
                      class="navbar-toggler navstyle"
                      type="button"
                    ...
                    <div class="collapse navbar-collapse" style="margin-left: 81px;" id="navbarNavAltMarkup">
