...
<title>Home</title>
  ...
  <body>
    ...
    <div class="container-fluid mt-1 ml-2 col-md-12">
      <div class="item">
        <img
          src="assests/shutterstock-324782423.jpg"
          srcset="
            assests/shutterstock-324782423@2x.jpg 2x,
            assests/shutterstock-324782423@3x.jpg 3x
          "
          class="headerimgservicestyle"
        />
        <div class="text_wrapper text-block centered">
          <h2 class="item--title ml_38 white_color banner_heading">Services</h2>
          <p class="item--text white_color serviceheadingstyles ">
    ...
    <div class="row mt-5 col-md-12 col-sm-12 col-lg-12">
      ...
      <b>  <h5 class="servicesheading">Business Intelligence & Analytics</h5> </b>
        <p class="card-text  Solutions_content_bodytradeservice Solutionstrade">
          RapidQube has the capability to provide solutions in best-in-class
          ...
          enhances quicker decision making.
        </p>

        <p class="card-text  Solutions_content_bodytradeservice">
        ...
        <div class="item--title sm-6">
        <b> <h5 class="card-text  Solutions_content_bodytradeservice "> </b>
            &nbsp;Our&nbsp;services&nbsp;range&nbsp;across&nbsp;the&nbsp;following&nbsp;
            areas&nbsp;of&nbsp;Analytics:
          </h5>
        </div>
<div class="followingstyle">
        <div class="row mt-2">
          <div class="col predictiveimgstyle">
            <img
              ...
              class="Group5style"
            />
            <span class="  servicescontent predictivestyle">
              Predictive
            </span>
          </div>
          <div class="col Diagnosticimgestyle">
            <img
              ...
              class="Group-5"
            />
            <span class=" servicescontent ">
              Diagnostic
            </span>
          </div>
          <div class="col Descriptiveimg">
            <img
              ...
              class="desimgstyle"
            />
            <span class=" servicescontent Descriptivestyle">
              Descriptive
            </span>
          </div>
        </div>
        <div class="row mt-4">
          <div class="col-md-4 Prescriptiveimgstyle">
            <img
              ...
              class="Group-5"
            />
            <span class="  servicescontent Prescriptivestyle ">
              Prescriptive
            </span>
          </div>
          <div class="col-md-6 mr_9 Searchbasedimgstyle">
            <img
            ...
            />
            <span class=" servicescontent Searchbasedstyle"
              >Search-based
            </span>
          </div>
    </div>
    ...
    <div class="row mt-5 col-md-12 col-sm-12 col-lg-12">
      ...
      <b> <h5 class="servicesheading ">
          Business Consulting
        </h5> </b>
        <p class="card-text  Solutions_content_bodytradeservice mt-4">
          Our leadership team possesses a unique blend of real-world experience.
          We will ensure that BOTH the people and technology changes needed for
          business transformation are identified and shared.
        </p>

        <p class="card-text  Solutions_content_bodytradeservice">
          Using our expertise, we will help define both “the tactical and
          strategic” using synergistic change management programs to address
          both.
        </p>
        <p class="card-text  Solutions_content_bodytradeservice">
          We will look across the business, technology, and customer ecosystems
          ...
          strategies and tactics (leveraging digital technologies) to succeed.
        </p>
      </div>
    ...
    <div class="row mt-5 col-md-12 col-sm-12 col-lg-12">
      ...
      <b> <h5 class="servicesheading">
        ...
        <p class="card-text  Solutions_content_bodytradeservice mt-4">
          The ongoing digital disruptions across industries has given rise to a
          ...
          management services including RapidQube's Cloud-First strategy.
        </p>
        <br />
        <div class="row">
        <b> <h5 class="card-text  Solutions_content_bodytradeservice">
            &nbsp;Infrastructure&nbsp;Management&nbsp;service&nbsp;portfolio&nbsp;
            includes:&nbsp;
          </h5> </b>
        </div>
        <br />
        <div class="infrastructurefollowing">
        <div class="row">
          <div class="col infrimg1style">
            <img
              src="assests/group-10.png"
              srcset="assests/group-10@2x.png 2x, assests/group-10@3x.png 3x"
              class="Group-5"
            />
            <span class="content_body infraname1style">Service&nbsp;desk</span>
          </div>
          <div class="col infraimg2style">
            <img
              ...
              class="Group-5"
            />
            <span class="infraname2style">Cloud&nbsp;Services</span>
          </div>
        </div>
        <div class="row mt-3">
          <div class="col infraimg3style">
            <img
              ...
              class="Group-5"
            />
            <span class="content_body infraname3style"
              >Enterprise&nbsp;Network&nbsp;Services&nbsp;</span
            >
          </div>
          <div class="col infraimg4style">
            <img
              ...
              class="Group-5"
            />
            <span class="content_body infraname4style"
              >System&nbsp;Integration&nbsp;Services</span
            >
          </div>
        </div>
        <div class="row mt-3">
          <div class="col infraimg5style">
            <img
              ...
              "
              class="Group-5"Descriptiveimg
            />
            <span class="ml-1  infrainame5style "
      ...
      <div class="col-md-2 col-sm-2 col-lg-2">
        <img
          src="assests/services/shutterstock-331398086-copy-3.png"
          srcset="
            assests/shutterstock-331398086-copy-3@2x.png 2x,
            assests/shutterstock-331398086-copy-3@3x.png 3x
          "
          class="serviceimg1"
        />
      </div>
    ...
    <div class="row col-md-12 col-sm-12 col-lg-12">
      ...
      <div class="col-md-5 col-sm-5 col-lg-5 ml-auto mt-5 pt_6">
       <b> <h5 class="educationservicestyle">
          Education
        </h5></b>
        <p class="card-text  Solutions_content_bodytradeservice mt-4">
          We feel that as technologies change, the approach towards education
        ...
        <p class="card-text  Solutions_content_bodytradeservice mt-4">
          We hosted over 200 hours of industry specific Use Case/ solution
    ...
    <div class="row mt-5 col-md-12 col-sm-12 col-lg-12">
      <div class="col-md-2 col-sm-2 col-lg-2">
        <img
          ...
          "
          class="Group-5-Copy-4 sidenavebarservicestyle"
        />
      </div>
      <div class="conclusionstyle">
      <div class="col laststyle">
