...
<body>
  ...
  <div class="container-fluid">
    <img src="assests/group-21.png" srcset="assests/group-21@2x.png 2x,assests/group-21@3x.png 3x"
      class="landing_image" >
    <button type="button" href="#" data-toggle="modal" data-target="#myModal"class=" ml-5 btn btn-link explore_more">Explore --&gt;
    </button>
  </div>
  <div class="container our_specialization" >
    <span class="heading pl_9" >Our Specialization</span>
  ...
  <div class="row shadoweffect">
      ...
      <div class="col-md-4">
            ...
            <p class="card-text smallheading pnSB mt-3">Our Latest Article About BlockChain And Health Care</p>
            <a href="blog.php" class="btn btn-link mt-3 pnSB ">Read More --->
      </div>
      ...
      <div class="col-md-4">
          ...
          <p class="smallheading pnSB mt-3">Twitter Handler @Rapdiqube </p>
            <a href="https://twitter.com/rapidqube" class="btn btn-link mt-4 pnSB "> Our Achivements ---> </a>
      </div>
  </div>
