                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pl-2">
                                ...
                                <button class="btn btn-default navBarName pl_10 custom-button" onclick="location.href = 'solutions.php';"
                            ...
                            <td class="pr-5">
                                <a href="services.php">
                                    <h5 class="navBarName pl_10 mt-2">Services</h5>
                                </a>
                            </td>
                            <td class="mr-2">
                                <a href="aboutus.php">
                                    <h5 class="navBarName pl_10 mt-2">About Us</h5>
                                </a>
                            </td>
                            <td class="mr-2">
                                <a href="contactus.php">
                                    <h5 class="navBarName pl_10 mt-2">info@rapidqube.com</h5>
                                </a>
                            </td>
                            <td class="mr-2">
